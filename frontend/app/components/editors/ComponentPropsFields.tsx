...
export function ComponentPropsFields({
  ...
  switch (componentType) {
      ...
      return (
        <div className='grid grid-cols-2 gap-3'>
          <div>
            ...
            <Input type='text' value={props.hashtag || ''} onChange={e => updateProp(componentType, 'hashtag', e.target.value)}
              className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' placeholder='#Hashtag' />
          </div>
          <div>
            <label className='block text-xs text-text-secondary mb-1'>URL</label>
            <Input type='text' value={props.url || ''} onChange={e => updateProp(componentType, 'url', e.target.value)}
              className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' placeholder='website.com' />
          </div>
        </div>
      );
    case 'chyron':
      ...
      return (
        <div className='grid grid-cols-2 gap-3'>
          <div>
            ...
            <Input type='text' value={props.title || ''} onChange={e => updateProp(componentType, 'title', e.target.value)}
              className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' placeholder='Program title' />
          </div>
          <div>
            <label className='block text-xs text-text-secondary mb-1'>Date</label>
            <Input type='text' value={props.date || ''} onChange={e => updateProp(componentType, 'date', e.target.value)}
      ...
      return (
        <div className='space-y-3'>
          <div>
            ...
            <Input type='text' value={props.sourceUrl || ''} onChange={e => updateProp(componentType, 'sourceUrl', e.target.value)}
              className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' placeholder='https://example.com/stream.m3u8' />
          </div>
          <div>
            <label className='block text-xs text-text-secondary mb-1'>Poster URL (optional)</label>
            <Input type='text' value={props.posterUrl || ''} onChange={e => updateProp(componentType, 'posterUrl', e.target.value)}
              className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' placeholder='https://example.com/poster.jpg' />
          </div>
          <div className='grid grid-cols-2 gap-3'>
            <label className='text-sm text-text-primary'>
              <span className='block text-xs text-text-secondary mb-1'>Fit Mode</span>
              <Select value={props.objectFit || 'cover'} onChange={v => updateProp(componentType, 'objectFit', v)}
                className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50'
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-3'>
            ...
            <label className='flex items-center gap-2 text-sm text-text-primary'>
              <Input type='checkbox' checked={toBoolean(props.showControls, false)} onChange={e => updateProp(componentType, 'showControls', e.target.checked)} className='h-4 w-4' />
    ...
    case 'qr-code':
      return (
        <div>
          ...
          <Input type='text' value={props.content || ''} onChange={e => updateProp(componentType, 'content', e.target.value)}
            className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' placeholder='https://example.com' />
      ...
      return (
        <div className='grid grid-cols-2 gap-3'>
          <div>
            ...
            <Input type='text' value={props.headerTitle || ''} onChange={e => updateProp(componentType, 'headerTitle', e.target.value)}
              className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' placeholder='Program title' />
          </div>
          <div>
            <label className='block text-xs text-text-secondary mb-1'>Hashtag</label>
          ...
          {toBoolean(props.showChyron, false) ? (
            <div className='col-span-2'>
              ...
              <Input type='text' value={props.chyronText || ''} onChange={e => updateProp(componentType, 'chyronText', e.target.value)}
                className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' placeholder='Optional lower chyron text' />
            </div>
          ) : null}
          <div className='col-span-2'>
            <label className='block text-xs text-text-secondary mb-1'>QR Code Content</label>
            <Input type='text' value={props.qrCodeContent || ''} onChange={e => updateProp(componentType, 'qrCodeContent', e.target.value)}
              className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' placeholder='https://example.com' />
          </div>
          <div className='col-span-2'>
            <label className='block text-xs text-text-secondary mb-1'>Clock Timezone</label>
            <Select value={props.clockTimezone || 'America/Argentina/Buenos_Aires'} onChange={v => updateProp(componentType, 'clockTimezone', v)}
              className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' options={timezoneOptions} />
          </div>
        </div>
      );
    case 'clock-widget':
      return (
        <div>
          ...
          <Select value={props.timezone || 'America/Argentina/Buenos_Aires'} onChange={v => updateProp(componentType, 'timezone', v)}
            className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' options={timezoneOptions} />
        </div>
      );
    case 'reloj-clock':
      ...
      return (
        <div className='space-y-2'>
          <div>
            ...
            <Select value={props.timezone || 'Europe/Madrid'} onChange={v => updateProp(componentType, 'timezone', v)}
              className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' options={timezoneOptions} />
          </div>
    ...
    case 'reloj-digital-loop-clock':
      return <RelojDigitalEditorFields componentType={componentType} props={props} updateProp={updateProp} replaceProps={replaceProps} commitProps={commitProps} timezoneOptions={timezoneOptions} />;
    case 'toni-chyron':
      ...
      return (
        <div className='space-y-4'>
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3'>
            <label className='flex items-center gap-2 text-sm text-text-primary'>
              <Input type='checkbox' checked={toBoolean(props.showWorldClocks, true)} onChange={e => updateProp(componentType, 'showWorldClocks', e.target.checked)} className='h-4 w-4' />
              Show World Clocks
            </label>
            {canToggleBellIcon ? (
              <label className='flex items-center gap-2 text-sm text-text-primary'>
                <Input type='checkbox' checked={toBoolean(props.showBellIcon, false)} onChange={e => updateProp(componentType, 'showBellIcon', e.target.checked)} className='h-4 w-4' />
                Show Bell Icon
              </label>
            ) : <div className='text-sm text-text-secondary'>FifthBell clock icon is always enabled.</div>}
            <label className='flex items-center gap-2 text-sm text-text-primary'>
              <Input type='checkbox' checked={toBoolean(props.worldClockShuffle, false)} onChange={e => updateProp(componentType, 'worldClockShuffle', e.target.checked)} className='h-4 w-4' />
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3'>
            <label className='text-sm text-text-primary'>
              ...
              <Input type='number' min={500} value={props.worldClockRotateIntervalMs ?? 5000}
            ...
            <label className='text-sm text-text-primary'>
              ...
              <Input type='number' min={0} value={props.worldClockTransitionMs ?? 300}
            ...
            <label className='text-sm text-text-primary'>
              ...
              <Input type='number' min={120} value={props.worldClockWidthPx ?? 200}
          ...
          <div className='space-y-2'>
            ...
            <Textarea defaultValue={worldClockCitiesDefaultValue}
              onBlur={e => {
                if (!e.target.value.trim()) { updateProp(componentType, 'worldClockCities', []); return; }
                try {
                ...
                } catch (err) { console.error('Invalid worldClockCities JSON:', err); }
              }}
              rows={6} className='w-full px-3 py-2 text-sm border rounded font-mono focus:ring-2 focus:ring-sea/50' />
      ...
      return (
        <div className='space-y-3'>
          ...
          <div>
            <label className='block text-xs text-text-secondary mb-1'>Text</label>
            <Input type='text' value={props.text || ''} onChange={e => updateProp(componentType, 'text', e.target.value)}
              className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' placeholder='Disclaimer text' />
          </div>
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3'>
            ...
            <label className='text-sm text-text-primary'>
              ...
              <Select value={props.align || 'right'} onChange={v => updateProp(componentType, 'align', v)}
                className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50'
                options={[{ value: 'left', label: 'Left' }, { value: 'center', label: 'Center' }, { value: 'right', label: 'Right' }]} />
            </label>
            <label className='text-sm text-text-primary'>
              <span className='block text-xs text-text-secondary mb-1'>Bottom (px)</span>
              <Input type='number' min={0} value={props.bottomPx ?? 24}
            ...
            <label className='text-sm text-text-primary'>
              ...
              <Input type='number' min={10} value={props.fontSizePx ?? 20}
          ...
          <label className='text-sm text-text-primary block max-w-xs'>
            ...
            <Input type='number' min={0} max={1} step={0.05} value={props.opacity ?? 0.82}
      ...
      return (
        <div className='space-y-3'>
          <label className='block text-sm text-text-primary'>
            ...
            <Textarea value={props.text || ''} onChange={e => updateProp(componentType, 'text', e.target.value)}
              className='mt-1 w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50 h-24' placeholder='Enter chyron text...' />
          </label>
        </div>
      );
    case 'cronica-reiteramos':
      return (
        <div className='space-y-3'>
          <label className='block text-sm text-text-primary'>
            Text
            <Input type='text' value={props.text || 'REITERAMOS'} onChange={e => updateProp(componentType, 'text', e.target.value)}
              className='mt-1 w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' />
          </label>
          <label className='flex items-center gap-2 text-sm text-text-primary'>
            <Input type='checkbox' checked={toBoolean(props.show, true)} onChange={e => updateProp(componentType, 'show', e.target.checked)}
      ...
      return (
        <div className='space-y-2'>
          <div>
            ...
            <Input type='text' value={props.label || 'EARONE'} onChange={e => updateProp(componentType, 'label', e.target.value)}
              className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' placeholder='EARONE' />
          </div>
          <div className='grid grid-cols-2 gap-3'>
            <div>
              <label className='block text-xs text-text-secondary mb-1'>Rank</label>
              <Input type='text' value={props.rank || ''} onChange={e => updateProp(componentType, 'rank', e.target.value)}
                className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' placeholder='Uses active sequence item' />
            </div>
            <div>
              <label className='block text-xs text-text-secondary mb-1'>Spins Today</label>
              <Input type='text' value={props.spins || ''} onChange={e => updateProp(componentType, 'spins', e.target.value)}
                className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' placeholder='Uses active sequence item' />
            </div>
          </div>
      ...
      return (
        <div className='space-y-4'>
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3'>
            {supportsContent && (
              <label className='flex items-center gap-2 text-sm text-text-primary'>
                <Input type='checkbox' checked={toBoolean(props.showArticles, true)} onChange={e => updateProp(componentType, 'showArticles', e.target.checked)} className='h-4 w-4' />
                Show Articles
              </label>
            )}
            {supportsContent && (
              <label className='flex items-center gap-2 text-sm text-text-primary'>
                <Input type='checkbox' checked={toBoolean(props.showWeather, true)} onChange={e => updateProp(componentType, 'showWeather', e.target.checked)} className='h-4 w-4' />
                Show Weather
              </label>
            )}
            {supportsContent && (
              <label className='flex items-center gap-2 text-sm text-text-primary'>
                <Input type='checkbox' checked={toBoolean(props.showEarthquakes, true)} onChange={e => updateProp(componentType, 'showEarthquakes', e.target.checked)} className='h-4 w-4' />
                Show Earthquakes
              </label>
            )}
            {supportsContent && (
              <label className='flex items-center gap-2 text-sm text-text-primary'>
                <Input type='checkbox' checked={toBoolean(props.showMarkets, true)} onChange={e => updateProp(componentType, 'showMarkets', e.target.checked)} className='h-4 w-4' />
                Show Markets
              </label>
            )}
            {supportsMarquee && (
              <label className='flex items-center gap-2 text-sm text-text-primary'>
                <Input type='checkbox' checked={toBoolean(props.showMarquee, false)} onChange={e => updateProp(componentType, 'showMarquee', e.target.checked)} className='h-4 w-4' />
                Show Bottom Marquee
              </label>
            )}
            {supportsContent && (
              <label className='flex items-center gap-2 text-sm text-text-primary'>
                <Input type='checkbox' checked={toBoolean(props.showCallsignTake, true)} onChange={e => updateProp(componentType, 'showCallsignTake', e.target.checked)} className='h-4 w-4' />
                Show Callsign Take
              </label>
            )}
            {supportsContent && (
              <label className='text-sm text-text-primary'>
                ...
                <Input type='number' min={1000} value={props.dataLoadTimeoutMs ?? 15000}
            ...
            {supportsContent && (
              <label className='text-sm text-text-primary'>
                ...
                <Input type='number' min={1000} value={props.articlesDurationMs ?? 10000}
            ...
            {supportsContent && (
              <label className='text-sm text-text-primary'>
                ...
                <Input type='number' min={1000} value={props.weatherDurationMs ?? 5000}
            ...
            {supportsContent && (
              <label className='text-sm text-text-primary'>
                ...
                <Input type='number' min={1000} value={props.earthquakesDurationMs ?? 10000}
            ...
            {supportsContent && (
              <label className='text-sm text-text-primary'>
                ...
                <Input type='number' min={1000} value={props.marketsDurationMs ?? 10000}
            ...
            {supportsContent && (
              <label className='text-sm text-text-primary'>
                ...
                <Input type='number' min={1000} value={props.playlistDefaultDurationMs ?? 10000}
            ...
            {supportsContent && (
              <label className='text-sm text-text-primary'>
                ...
                <Input type='number' min={50} value={props.playlistUpdateIntervalMs ?? 100}
              ...
              <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-1.5'>
                {FIFTHBELL_AVAILABLE_WEATHER_CITIES.map(city => (
                  <label key={city} className='flex items-center gap-1.5 text-xs text-text-primary cursor-pointer'>
                    <Input type='checkbox' checked={selectedCitySet.has(city)} onChange={e => {
          ...
          {supportsContent && (
            <div className='space-y-2'>
              ...
              <Input type='text' value={languageRotation.join(', ')}
                onChange={e => updateProp(componentType, 'languageRotation', e.target.value.split(',').map(s => s.trim()).filter(Boolean))}
                className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' placeholder='en, es, en, it' />
            </div>
          )}
          ...
          {supportsContent && (
            <details className='rounded border border-dashed border-sand/40 px-3 py-2'>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 pt-3'>
                <label className='flex items-center gap-2 text-sm text-text-primary'>
                  <Input type='checkbox' checked={toBoolean(props.audioCueEnabled, true)} onChange={e => updateProp(componentType, 'audioCueEnabled', e.target.checked)} className='h-4 w-4' />
                  Audio Cue
                </label>
                <label className='text-sm text-text-primary'>
                  <span className='block text-xs text-text-secondary mb-1'>Cue Minute</span>
                  <Input type='number' min={0} max={59} value={props.audioCueMinute ?? 59}
                ...
                <label className='text-sm text-text-primary'>
                  ...
                  <Input type='number' min={0} max={59} value={props.audioCueSecond ?? 55}
                ...
                <label className='text-sm text-text-primary'>
                  ...
                  <Input type='text' value={props.callsignPrelaunchUntilNyc ?? ''}
                    onChange={e => updateProp(componentType, 'callsignPrelaunchUntilNyc', e.target.value)}
                    className='w-full px-3 py-2 text-sm border rounded focus:ring-2 focus:ring-sea/50' placeholder='2026-01-02T21:30:00' />
                </label>
                <label className='text-sm text-text-primary'>
                  <span className='block text-xs text-text-secondary mb-1'>Callsign Window Start (s)</span>
                  <Input type='number' min={0} max={59} value={props.callsignWindowStartSecond ?? 50}
                ...
                <label className='text-sm text-text-primary'>
                  ...
                  <Input type='number' min={0} max={59} value={props.callsignWindowEndSecond ?? 3}
            ...
            <div className='space-y-3'>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3'>
                <label className='text-sm text-text-primary'>
                  ...
                  <Input type='number' min={1} value={props.marqueeMinPostsCount ?? 4}
                ...
                <label className='text-sm text-text-primary'>
                  ...
                  <Input type='number' min={0} max={1} step={0.01} value={props.marqueeMinAverageRelevance ?? 0}
                ...
                <label className='text-sm text-text-primary'>
                  ...
                  <Input type='number' min={0} max={1} step={0.01} value={props.marqueeMinMedianRelevance ?? 0}
                ...
                <label className='text-sm text-text-primary'>
                  ...
                  <Input type='number' min={1} value={props.marqueePixelsPerSecond ?? 150}
                ...
                <label className='text-sm text-text-primary'>
                  ...
                  <Input type='number' min={1} value={props.marqueeMinDurationSeconds ?? 10}
                ...
                <label className='text-sm text-text-primary'>
                  ...
                  <Input type='number' min={20} value={props.marqueeHeightPx ?? 72}
...
export function ZIndexField({
  ...
  return (
    <div className='mt-3 flex items-center gap-3 border-t border-sand/20 pt-3'>
      ...
      <Input type='number' value={zIndex} min={-100} max={100}
